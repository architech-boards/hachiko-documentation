...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="rootfs_rst-host-51" class="language-markup">sudo dd if=/path/to/image.jffs2 of=/path/to/your/USB/device</code></pre>
